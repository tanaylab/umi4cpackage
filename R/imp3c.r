...
gtrack.create_redb_tracks = function(re_seq, redb_params_fn, verbose = FALSE)
{
    ...
    message("Importning tracks flen_track ", flen_track, " gc_track ", gc_track)
    ...
    gtrack.create(fragmap_track, paste(re_seq, "fragment mapability"), as.character(mapab_track), 
        iterator = flen_track)
